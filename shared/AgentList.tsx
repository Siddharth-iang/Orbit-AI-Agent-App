export const AgentList = [
    {
      ...
      image: require('../assets/images/writingassistant.png'),
    ...
    },
    {
      ...
      image: require('../assets/images/imagegenerator.png'),
      initialText: 'A futuristic city skyline at sunset in cyberpunk style.',
      prompt:
        'You are an AI image generator. Convert text into creative images.',
      type: 'image',
      featured: true,
    },
    {
    ...
    },
    {
      ...
      image: require('../assets/images/productcoach.png'),
    ...
    },
    {
      ...
      image: require('../assets/images/captiongenerator.png'),
    ...
    // },
    {
      ...
      image: require('../assets/images/fitnesscoach.png'),
      initialText: 'Create a 4-day workout plan for weight loss.',
      prompt:
        'You are a fitness assistant. Suggest workouts and meal plans.',
      type: 'chat',
      featured: false,
    },
    {
      ...
      image: require('../assets/images/codeassist.png'),
      initialText: 'Write a Python function to check if a number is prime.',
      prompt:
        'You are a coding assistant. Generate and explain code.',
      type: 'chat',
      featured: false,
    },
    {
      ...
      image: require('../assets/images/researchanalyst.png'),
      initialText: 'Summarize key points from an article about climate change.',
      prompt:
        'You are a research assistant. Summarize and simplify information.',
      type: 'chat',
      featured: false,
    },
    {
      ...
      image: require('../assets/images/stotell.png'),
    ...
    },
    {
      ...
      image: require('../assets/images/emailgen.png'),
      initialText: 'Write a professional email to a client about project updates.',
      prompt:
        'You are an email assistant. Write clear, concise emails.',
      type: 'chat',
      featured: false,
    },
  ];
